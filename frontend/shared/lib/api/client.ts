...
function toAppError(err: unknown, fallbackMessage = "Request failed"): AppError {
...
type FetchOpts = Omit<RequestInit, "body"> & { headers?: Record<string, string> };
...
export const api = {
  ...
  patch: <TRes, TBody = unknown>(path: string, body?: TBody, opts?: FetchOpts) =>
