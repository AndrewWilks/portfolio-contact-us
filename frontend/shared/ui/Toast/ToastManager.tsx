                ...
                <div className="flex-0 mt-0.5">
                  {t.variant === "error" ? (
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-4a1 1 0 112 0 1 1 0 01-2 0zm0-7a1 1 0 012 0v4a 1 1 0 11-2 0V7z"
                        clipRule="evenodd"
                      />
                    </svg>
                  ) : t.variant === "success" ? (
                ...
                <div className="flex-0 ml-2 flex items-center gap-2">
                  {t.actionLabel ? (
                    <button
                      ...
                      className={
                        "px-2 py-1 rounded text-sm font-medium focus:outline-none " +
